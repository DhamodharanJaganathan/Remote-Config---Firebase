...
public class HomeActivity extends AppCompatActivity {
    ...
    public void checkAppUpdate() {
        ...
        Task<Void> fetchTask=mFirebaseRemoteConfig.fetch(0);
        ...
        fetchTask.addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    }else if (latestAppVersion == versionCode){

                        Toast.makeText(HomeActivity.this, "Same version", Toast.LENGTH_SHORT).show();
